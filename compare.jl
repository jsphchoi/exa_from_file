using ExaModels, MadNLP, JuMP, PowerModels, CUDA, MadNLPGPU
...
case3 = ac_power_model("pglib_opf_case3_lmbd.m"; backend = CUDABackend())
madnlp(case3)

# Automatic .m → ExaModel formulation
include("exa_from_file.jl")
case3m = exa_from_file("pglib_opf_case3_lmbd.m", backend = CUDABackend())
madnlp(case3m)